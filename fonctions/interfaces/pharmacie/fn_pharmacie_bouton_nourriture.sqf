...
private _fond_bouton_nourriture = (findDisplay 7000) displayCtrl 7006;
private _fond_bouton_boissons = (findDisplay 7000) displayCtrl 7007;
private _bouton_acheter = (findDisplay 7000) displayCtrl 7003;

_fond_bouton_nourriture ctrlSetBackgroundColor [0.6,0,0,0.25];
_fond_bouton_boissons ctrlSetBackgroundColor [0,0,0,0];
bouton_A_OK = true;
