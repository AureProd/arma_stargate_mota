...
addMissionEventHandler ["HandleDisconnect", 
{
	...
	else 
	{
		...
		[_uid, _name, _classes, (_variable select 2), (_variable select 3), (_variable select 4), (_variable select 5), (_variable select 6), (_variable select 7), _inventaire_reel, _inventaire_virtuel, (getPos _unit), (_variable select 10), (_variable select 11), (_variable select 12), (_variable select 13)] remoteExec ["db_fnc_sauvegardeBdd", 2];
	};
