	...
	class items
    {
        ...
        */
        tableau_items[] = {
            ...
            {9, 0, "bouteille_goauld", "pictures\items\bouteille.paa", 2, 1.5, 0, 10, 0, 30},
            {10, 0, "sandwich_goauld", "pictures\items\sandwich.paa", 1, 1, 0, 8, 0, 30},
            ...
            {14, 0, "raisin", "pictures\items\raisin_baselvl0_20.paa", 6, 0.5, 0, 5, 2, 20},
            {15, 20, "raisin", "pictures\items\raisin_mediocrelvl20_40.paa", 6, 0.5, 0, 45, 2, 40},
            {16, 40, "raisin", "pictures\items\raisin_superieurlvl40_60.paa", 6, 0.5, 0, 75, 2, 60},
