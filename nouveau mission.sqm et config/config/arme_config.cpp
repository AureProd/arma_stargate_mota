...
class stargate_armes
{
	class guns_tauri
	{
        ...
        chargeurs[] = { // { nom / level / prix / id de l'arme / id du chargeur / fonction }
            // Armes de poing
			{"Chargeur rook", 0, 10, "hgun_Rook40_F", "16Rnd_9x21_Mag", "['16Rnd_9x21_Mag'] call mission_fnc_add_chargeur"},
            {"Chargeur P 07", 15, 12, "hgun_P07_F", "16Rnd_9x21_Mag", "['16Rnd_9x21_Mag'] call mission_fnc_add_chargeur"},
            {"Chargeur ACP 2", 25, 20, "hgun_ACPC2_F", "9Rnd_45ACP_Mag", "['9Rnd_45ACP_Mag'] call mission_fnc_add_chargeur"},
            {"Chargeur 4 five", 30, 25, "hgun_Pistol_heavy_01_F", "11Rnd_45ACP_Mag", "['11Rnd_45ACP_Mag'] call mission_fnc_add_chargeur"},
            {"Chargeur MP5", 30, 50, "SMG_05_F", "30Rnd_9x21_Mag_SMG_02", "['30Rnd_9x21_Mag_SMG_02'] call mission_fnc_add_chargeur"},
            {"Chargeur SPAS 12", 40, 55, "SGA_SPAS12", "SGA_SPAS12MAG_pellets", "['SGA_SPAS12MAG_pellets'] call mission_fnc_add_chargeur"},
            {"Chargeur P 90", 50, 85, "SMG_03C_TR_black", "50Rnd_570x28_SMG_03", "['50Rnd_570x28_SMG_03'] call mission_fnc_add_chargeur"},
            {"Chargeur MK 14", 55, 90, "srifle_DMR_06_olive_F", "20Rnd_762x51_Mag", "['20Rnd_762x51_Mag'] call mission_fnc_add_chargeur"},
            {"Chargeur LIM", 60, 200, "LMG_03_F", "200Rnd_556x45_Box_F", "['200Rnd_556x45_Box_F'] call mission_fnc_add_chargeur"}
		};
        viseurs[] = { // { nom / level / prix / id de arme }
            {"MRD rouge", 30, 55, "optic_MRD", "['optic_MRD'] call mission_fnc_add_viseur"},
            {"ACO 1 rouge", 30, 60, "optic_Aco", "['optic_Aco'] call mission_fnc_add_viseur"},
            {"ACO 1 verte", 30, 65, "optic_ACO_grn", "['optic_ACO_grn'] call mission_fnc_add_viseur"},
            {"ACO 2 rouge", 30, 67, "optic_Aco_smg", "['optic_Aco_smg'] call mission_fnc_add_viseur"},
            {"ACO 2 verte", 30, 70, "optic_ACO_grn_smg", "['optic_ACO_grn_smg'] call mission_fnc_add_viseur"},
            {"Holographique 1", 40, 80, "optic_Holosight", "['optic_Holosight'] call mission_fnc_add_viseur"},
            {"Holographique 2", 40, 85, "optic_Holosight_smg", "['optic_Holosight_smg'] call mission_fnc_add_viseur"},
    ...
    class guns_goauld
	{
        ...
        chargeurs[] = { // { nom / level / prix / id de l'arme / id du chargeur / fonction }
            ...
            {"Chargeur Zat'ni'katel", 15, 45, "sga_zat_mag_closed", "sga_zat_mag_closed", "['sga_zat_mag_closed'] call mission_fnc_add_chargeur"}
		};
