...
class stargate_vetements
{
	class vetements_tauri
	{
		tenue[] = { // { nom / level / prix / id de l'objet / fonction }
			{"", 0, 0, "U_C_Poloshirt_stripped", "player forceAddUniform 'U_C_Poloshirt_stripped';"},
            {"", 0, 0, "U_C_Poloshirt_redwhite", "player forceAddUniform 'U_C_Poloshirt_redwhite';"},
			{"", 0, 0, "U_C_Poloshirt_salmon", "player forceAddUniform 'U_C_Poloshirt_salmon';"},
			{"", 0, 0, "U_C_Poloshirt_blue", "player forceAddUniform 'U_C_Poloshirt_blue';"},
			{"", 0, 0, "U_C_Poloshirt_burgundy", "player forceAddUniform 'U_C_Poloshirt_burgundy';"},
			{"", 0, 0, "U_C_Poloshirt_tricolour", "player forceAddUniform 'U_C_Poloshirt_tricolour';"},
			{"", 0, 0, "U_C_man_sport_1_F", "player forceAddUniform 'U_C_man_sport_1_F';"},
			{"", 0, 0, "U_C_man_sport_2_F", "player forceAddUniform 'U_C_man_sport_2_F';"},
			{"", 0, 0, "U_C_man_sport_3_F", "player forceAddUniform 'U_C_man_sport_3_F';"},
			{"", 2, 2, "U_C_Poor_2", "player forceAddUniform 'U_C_Poor_2';"},
			{"", 2, 2, "U_OrestesBody", "player forceAddUniform 'U_OrestesBody';"},
			{"", 2, 2, "U_C_WorkerCoveralls", "player forceAddUniform 'U_C_WorkerCoveralls';"},
			{"", 2, 2, "U_C_Man_casual_1_F", "player forceAddUniform 'U_C_Man_casual_1_F';"},
			{"", 2, 2, "U_C_Man_casual_2_F", "player forceAddUniform 'U_C_Man_casual_2_F';"},
			{"", 2, 2, "U_C_Man_casual_3_F", "player forceAddUniform 'U_C_Man_casual_3_F';"},
			{"", 2, 2, "U_C_Man_casual_4_F", "player forceAddUniform 'U_C_Man_casual_4_F';"},
			{"", 2, 2, "U_C_Man_casual_5_F", "player forceAddUniform 'U_C_Man_casual_5_F';"},
			{"", 2, 2, "U_C_Man_casual_6_F", "player forceAddUniform 'U_C_Man_casual_6_F';"},
            {"", 60, 100, "U_NikosBody", "player forceAddUniform 'U_NikosBody';"},
            {"", 60, 100, "U_NikosAgedBody", "player forceAddUniform 'U_NikosAgedBody';"}
		};
        veste[] = { // { nom / level / prix / id de l'objet / fonction }
			{"", 0, 0, "V_BandollierB_cbr", "player addVest 'V_BandollierB_cbr';"}
		};
        sac[] = { // { nom / level / prix / id de l'objet / fonction }
            {"", 0, 0, "B_OutdoorPack_blk", "player addBackpack 'B_OutdoorPack_blk';"},
			{"", 1, 3, "B_AssaultPack_khk", "player addBackpack 'B_AssaultPack_khk';"},
			{"", 1, 3, "B_AssaultPack_dgtl", "player addBackpack 'B_AssaultPack_dgtl';"},
			{"", 1, 3, "B_AssaultPack_rgr", "player addBackpack 'B_AssaultPack_rgr';"},
			{"", 2, 5, "B_AssaultPack_sgg", "player addBackpack 'B_AssaultPack_sgg';"},
			{"", 2, 5, "B_AssaultPack_blk", "player addBackpack 'B_AssaultPack_blk';"},
			{"", 2, 5, "B_AssaultPack_cbr", "player addBackpack 'B_AssaultPack_cbr';"},
			{"", 2, 5, "B_AssaultPack_mcamo", "player addBackpack 'B_AssaultPack_mcamo';"},
			{"", 2, 5, "B_AssaultPack_tna_f", "player addBackpack 'B_AssaultPack_tna_f';"}
        };
        casque[] = { // { nom / level / prix / id de l'objet / fonction }
			{"", 0, 0, "H_Bandanna_surfer", "player addHeadgear 'H_Bandanna_surfer';"},
            {"", 0, 0, "H_Helmet_Skate", "player addHeadgear 'H_Helmet_Skate';"},
            {"", 0, 0, "H_Hat_blue", "player addHeadgear 'H_Hat_blue';"},
            {"", 0, 0, "H_Booniehat_tan", "player addHeadgear 'H_Booniehat_tan';"}
		};
        lunette[] = { // { nom / level / prix / id de l'objet / fonction }
			{"", 0, 0, "G_Shades_Black", "player addGoggles 'G_Shades_Black';"},
            {"", 0, 0, "G_Shades_Blue", "player addGoggles 'G_Shades_Blue';"},
            {"", 0, 0, "G_Sport_Blackred", "player addGoggles 'G_Sport_Blackred';"},
            {"", 0, 0, "G_Sport_Red", "player addGoggles 'G_Sport_Red';"}
		};
	};
    class vetements_tauri_militaire
	{
        ...
        casque[] = { // { nom / level / prix / id de l'objet / fonction }
			...
			{"", 3, 2, "H_HelmetB_tna_F", "player addHeadgear 'H_HelmetB_tna_F';"},
			...
			{"", 15, 4, "H_Beret_02", "player addHeadgear 'H_Beret_02';"},
			...
			{"", 30, 4, "YSA_HeadGear_Beret_Red", "player addHeadgear 'YSA_HeadGear_Beret_Red';"},
			{"", 45, 5, "H_Bandanna_gry", "player addHeadgear 'H_Bandanna_gry';"},
			{"", 45, 5, "H_Beret_blk", "player addHeadgear 'H_Beret_blk';"},
			{"", 45, 5, "H_PASGT_basic_black_F", "player addHeadgear 'H_PASGT_basic_black_F';"},
			{"", 45, 5, "H_Cap_blk", "player addHeadgear 'H_Cap_blk';"},
			{"", 45, 5, "H_HeadSet_black_F", "player addHeadgear 'H_HeadSet_black_F';"},
			...
			{"", 60, 10, "H_HelmetCrew_I", "player addHeadgear 'H_HelmetCrew_I';"},
			{"", 60, 10, "H_HelmetB_camo", "player addHeadgear 'H_HelmetB_camo';"},
