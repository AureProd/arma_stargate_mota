...
class stargate_vehicules 
{
	...
	{
		vehicules[] = { // id / nom / id arma / prix achat / prix location / level / type vehicule (0 = voiture civil, 1 = voiture armée, 2 = bateau)
	...
	class vehicules_tauri
	{
		vehicules[] = { // id / nom / id arma / prix achat / prix location / level / type vehicule (0 = voiture civil, 1 = voiture armée, 2 = bateau)
            ...
            {10, $STR_Pickup_gendarmerie, "B_GEN_Offroad_01_gen_F", 1000, 500, 0, 1},
            {11, $STR_van_transport_gendarmerie, "B_GEN_Van_02_transport_F", 1000, 500, 0, 1}
        };
	};
    class bateaux_peche 
    {
