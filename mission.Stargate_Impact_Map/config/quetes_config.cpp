...
class stargate_quetes
{
    /*
        ...
        Options TYPES Quête :
        |-> 1 (Quête addAction allé-retour) : [[dialogue_addAction, id_to_addAction, text_addAction, chargementON(0/1)], [dialogue_addAction, id_to_addAction, text_addAction]]
        ...
        |-> 5 (Quête addAction sans allé-retour) : [[dialogue_addAction, id_to_addAction, text_addAction], [dialogue_addAction, id_to_addAction, text_addAction]]
