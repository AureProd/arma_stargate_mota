...
_fond_bouton_maladie ctrlSetBackgroundColor [0.6,0,0,0.25];
...
[_logo_tete, (_liste_vies select 0)] call mission_fnc_change_color_logo;
[_logo_ventre, (_liste_vies select 1)] call mission_fnc_change_color_logo;
