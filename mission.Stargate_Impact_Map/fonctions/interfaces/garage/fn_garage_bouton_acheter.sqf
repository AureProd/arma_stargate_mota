...
private _paiement = [((_tab select 1) select 3)] call mission_fnc_paiement;
if (_paiement) then 
{
	[((_tab select 1) select 0)] call mission_fnc_add_garage;
};

[] call mission_fnc_garage_bouton_achat;