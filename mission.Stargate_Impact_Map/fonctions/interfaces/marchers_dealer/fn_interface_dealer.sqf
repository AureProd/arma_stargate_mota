...
{
	_image_fond ctrlSetText "pictures\interfaces\menu_achats\dealer\menumarchernoir_goauld.paa";
} 
else 
{
	_image_fond ctrlSetText "pictures\interfaces\menu_achats\dealer\menumarchernoir.paa";
};

bouton_A_OK = true; // magasin
//isMilitaire = param [0, false];

[] call mission_fnc_dealer_bouton_magasin;
