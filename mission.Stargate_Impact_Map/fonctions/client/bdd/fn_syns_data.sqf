...
[(getPlayerUID player), (name player), _licences, (_variable_bis select 2), (_variable_bis select 3), (_variable_bis select 4), (_variable_bis select 5), (_variable_bis select 6), (_variable_bis select 7), _loadout, _inventaire_virtuel, (getPos player), (_variable_bis select 10), (_variable_bis select 12), (_variable_bis select 13), (_variable_bis select 14), (_variable_bis select 15), (_variable_bis select 16)] remoteExec ["db_fnc_sauvegardeBdd", 2];
