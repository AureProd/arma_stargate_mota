...
class licenses_shop
{
	...
	class Controls
	{
		class background_picture
		{
			...
			style = 48;
			text = "pictures\interfaces\documents_interfaces\documents_interface_tauri_2.paa";
		...
		class licenses_list
		{
			...
			onLBDblClick = "playSound 'button'; [] call mission_fnc_interface_licences_db_clicks;";
            onLBSelChanged = "[] call mission_fnc_interface_licences_liste;";
		};
	};
};