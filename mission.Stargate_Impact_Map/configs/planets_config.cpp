...
class planets
{
	...
	class gates
	{
		...
		address_logos[] = { // address logo id / value for tauri gate / value for goauld gate / number of DHD address logo
			{1, 0, 0, 0}, // Earth
			...
			{13, 0.308, 0.308, 12}, // Aquila <-- dont use this logo in an address
