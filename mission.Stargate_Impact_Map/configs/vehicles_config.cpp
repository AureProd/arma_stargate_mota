...
class vehicles 
{
    class goauld_vehicles
	{
		vehicles[] = { // id / name / id arma / buy price / rent price / level / vehicle type (0 = civil car, 1 = army car, 2 = boat, 3 = police car)
            {1, $STR_Quad, "C_Quadbike_01_F", 50, 25, 0, 0},
            {2, $STR_Zodiak, "B_T_Boat_Transport_01_F", 1000, 500, 0, 2}
        };
	};
	class tauri_vehicles
	{
		vehicles[] = { // id / name / id arma / buy price / rent price / level / vehicle type (0 = civil car, 1 = army car, 2 = boat, 3 = police car)
            {1, $STR_Quad, "C_Quadbike_01_F", 50, 25, 0, 0},
    ...
    class fishing_boats
    {
        boats_for_fishing[] = {"B_T_Boat_Transport_01_F"};
    };
};