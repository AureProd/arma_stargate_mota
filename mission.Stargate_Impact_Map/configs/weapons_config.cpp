...
class weapons
{
	class tauri_weapons
	{
		weapons[] = { // { name / level / price / weapon id / loader id / function to add item }
        ...
        magazines[] = { // { name / level / price / weapon id / loader id / function to add item }
        ...
        sights[] = { // { nom / level / prix / id de arme }
    ...
    class goauld_weapons
	{
        ...
        sights[] = {}; // { name / level / price / sight id / function to add item }
	};
    class policeman_goauld_weapons
	{
		weapons[] = { // { name / level / price / weapon id / loader id / function to add item }
            {$STR_Lance_goauld, 0, 0, "sga_staffweapon", "sga_staffweapon_mag_on", "['sga_staffweapon', 'sga_staffweapon_mag_on'] call mission_fnc_add_weapon"}//,
            //{"Zat'ni'katel", 15, 100, "sga_zat", "sga_zat_mag_closed", "['sga_zat', 'sga_zat_mag_closed'] call mission_fnc_add_weapon"}
